...
<div class="border-end" id="sidebar-wrapper">
    ...
    <div class="list-group">
        <a class="list-group-item-action p-3 text-light" href="dashboard.php" style=" text-decoration: none;"><i class="fa-solid fa-gauge-high fa-beat-fade"></i> Dashboard</a>
        <a class="list-group-item list-group-item-action p-3 text-light" href="profile.php"><i class="fa-solid fa-user"></i> Profile</a>
        <a class="list-group-item list-group-item-action p-3 text-light" href="manage_user.php"><i class="fa-solid fa-user-gear"></i> User Management</a>
        ...
        <a class="list-group-item list-group-item-action p-3 text-light" href="coop_member.php"><i class="fa-solid fa-people-roof"></i> Cooperative Member</a>
        <a class="list-group-item list-group-item-action p-3 text-light" href="distribution.php"><i class="fa-solid fa-box-open"></i> Distribution</a>
        ...
        <a class="list-group-item list-group-item-action p-3 text-light" href="report.php"><i class="fa-solid fa-print"></i> Report</a>
