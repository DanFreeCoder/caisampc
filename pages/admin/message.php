                        ...
                        <div class="modal-body">
                            <div class="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="" class="select2 form-control user_to" style="width: 100%;">
                                        <option value="0" disabled selected>SEND TO</option>
                                        <?php
                                        // members name
                                        $users->role = 1;
                                        ...
                                        // echo ($count > 0) ? ' <option value="All">All</option>' : '';
                                        ?>
                                    </select>
                                </div>
                            </div>
                ...
                <div class="modal-dialog modal-dialog-scrollable">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" id="messageBody">
                            <!-- reply -->
                            <!-- the content of this from the controller which fetch in JS  -->
                        </div>
                        <div class="modal-footer">
